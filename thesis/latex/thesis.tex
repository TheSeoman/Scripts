...
\section{Multiomics}
\label{Introduction:Epigenetics}
...
Transcriptiomics examines the occurrence and level of RNAs on a genome-wide scale. Following the central dogma of molecular biology, RNA is the intermediate between DNA and proteins and therefore of central importance\cite{}. With the late progress in transcriptome studies, even more effects of RNA have been discovered in the form of several functional RNAs\cite{}. RNA levels can be measured using a technology called RNA-seq\cite{} or probe-based arrays\cite{}, as was the case with the data used in this work. 

The second field, Genomics, describes variation within between genomes. In this work we focused on single nucleotide polymorphisms (SNPs), which are single base changes. Genotypic information fills a special place in multi-omics analyses, as it not dependent on the environment and can be considered static in ones lifetime. Therefore, it is considered as the cause of changes instead of being a downstream effect of other changes\cite{Hasin2017}. This means they are an exceptional anchor for the start of multi-omics analyses. 
Genotypic changes are known to cause mendelian diseases, when the change lies in the coding region of a protein. They also influence gene expression levels, which in turn is the cause of common diseases\cite{Hasin2017}.

%\begin{itemize}
%\item rise in performance of different essays => multiomics
%\item aim of multiomics anlysis = integration of data types to ?
%\item Transcriptomics
%\begin{itemize}
%\item functional RNAs
%\item proxy for proteomics
%\item regulation of transcription = central control of cell activity
%\end{itemize}
%\item Genomics
%\begin{itemize}
%\item data in form of SNP variants = Phenotypes
%\item known effect on transcription regulation
%\item ?
%\end{itemize}
%\item epigenomics/epigenetics
%\begin{itemize}
%\item newest 'omics' field
...
%\item DNA methylation = focus of this work
%\begin{itemize}
...
We used multiomics data to analyze the mechanism of HERVs influence. 
